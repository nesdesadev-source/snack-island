...
describe('OrderService', () => {
  ...
  describe('updateOrderStatus', () => {
    it('should update order status and deduct inventory when completed', async () => {
      ...
      vi.mocked(supabase.rpc)
        .mockResolvedValueOnce({ data: mockOrder, error: null }) // updateOrder
        .mockResolvedValueOnce({ data: mockOrderItems, error: null }) // getOrderItems
    ...
    it('should not deduct inventory for non-completed status', async () => {
      const { deductInventoryForOrder } = await import('../../src/modules/orders/inventoryDeduction')
